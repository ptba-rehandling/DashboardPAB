...
# Periksa apakah file diupload dan memuat data
if fl is not None:
    filename = fl.name
    st.write(filename)

    # Memeriksa ekstensi file dan memuat data
    ...
    # Cek keberadaan kolom 'date' dan konversi ke datetime
