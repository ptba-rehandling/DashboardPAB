...
rakor_targets = {
    'FOB MV': st.sidebar.number_input("Target FOB MV (masukkan nilai target)", min_value=0, value=0),
    'Rehandling Blok Timur': st.sidebar.number_input("Target Rehandling Blok Timur (masukkan nilai target)", min_value=0, value=0),
    'Rehandling Antar Stock Blok Barat': st.sidebar.number_input("Target Rehandling Antar Stock Blok Barat (masukkan nilai target)", min_value=0, value=0),
    'Rehandling Antar Stock Blok Timur': st.sidebar.number_input("Target Rehandling Antar Stock Blok Timur (masukkan nilai target)", min_value=0, value=0),
    'Rehandling Blok Barat': st.sidebar.number_input("Target Rehandling Blok Barat (masukkan nilai target)", min_value=0, value=0),
    'Housekeeping': st.sidebar.number_input("Target Housekeeping (masukkan nilai target)", min_value=0, value=0),
    'Pengiriman konsumen': st.sidebar.number_input("Target Pengiriman konsumen (masukkan nilai target)", min_value=0, value=0)
}
...
rakor_df = df_filtered.groupby("status", as_index=False).agg({"tonase": "first", "target_rakor": "first"})
