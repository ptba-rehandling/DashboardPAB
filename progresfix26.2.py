...
for s in df["shift"].unique():
    shift_targets[s] = st.sidebar.number_input(f"Target for {s}", value=0)
...
rakor_targets = {
    'FOB MV': st.sidebar.number_input("Target FOB MV (masukkan nilai target)", value=get_value_by_status(df, 'FOB MV')),
    'Rehandling Blok Timur': st.sidebar.number_input("Target Rehandling Blok Timur (masukkan nilai target)", value=get_value_by_status(df, 'Rehandling Blok Timur')),
    'Rehandling Antar Stock Blok Barat': st.sidebar.number_input("Target Rehandling Antar Stock Blok Barat (masukkan nilai target)", value=get_value_by_status(df, 'Rehandling Antar Stock Blok Barat')),
    'Rehandling Antar Stock Blok Timur': st.sidebar.number_input("Target Rehandling Antar Stock Blok Timur (masukkan nilai target)", value=get_value_by_status(df, 'Rehandling Antar Stock Blok Timur')),
    'Rehandling Blok Barat': st.sidebar.number_input("Target Rehandling Blok Barat (masukkan nilai target)", value=get_value_by_status(df, 'Rehandling Blok Barat')),
    'Houskeeping': st.sidebar.number_input("Target Housekeeping (masukkan nilai target)", value=get_value_by_status(df, 'Houskeeping')),
    'Pengiriman konsumen': st.sidebar.number_input("Target Pengiriman konsumen (masukkan nilai target)", value=get_value_by_status(df, 'Pengiriman konsumen'))
}
